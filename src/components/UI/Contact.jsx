        ...
        <section className='pb-16' id='contact'>
            <div className="container">
                ...
                <div className="md:flex justify-between items-center">
                    ...
                    <div className="w-full mt-8 md:mt-0 md:w-/12 sm:h-[450px] lg:flex items-center bg-indigo-100 px-4 lg:px-8 py-4">
                        <form className="w-full">
                            ...
                            <button className='w-full p-3 focus:outline-none rounded-[5px] bg-smallTextColor text-white hover:bg-headingColor text-center ease-linear duration-200'>
                                Send Message
                            </button>
                        </form>
                    </div>
